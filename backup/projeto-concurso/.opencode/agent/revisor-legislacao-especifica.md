---
description: Revisor de questões da área Legislação Específica (banco Rio Verde Concurso, arquitetura v3). Recebe o bundle da área do organizador, revisa com a rubrica própria e devolve correções em spec .md. Sequencial, isolado por área.
mode: subagent
permission:
  bash: deny
  edit:
...
- **Fontes:** `REGIMENTO INTERNO - Câmara Municipal de Rio Verde.md`, `LEI ORGÂNICA - Rio Verde.md`, `LEI Nº 7.434-2023 - Estrutura Organizacional Câmara Rio Verde.md`, `LEI Nº 7.435-2023 - Plano de Cargos Câmara Rio Verde.md`.
- **Foco de verificação:**
  - Normas municipais rioverdenses e relações entre os poderes municipais.
  - **Cada citação conferida contra o texto da fonte** (artigo/inciso).
