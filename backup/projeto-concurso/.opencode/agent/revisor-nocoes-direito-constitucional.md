---
description: Revisor de questões da área Noções de Direito Constitucional (banco Rio Verde Concurso, arquitetura v3). Recebe o bundle da área do organizador, revisa com a rubrica própria e devolve correções em spec .md. Sequencial, isolado por área.
mode: subagent
permission:
  bash: deny
  edit:
...
- **Fontes:** `CONSTITUIÇÃO DA REPÚBLICA FEDERATIVA DO BRASIL DE 1988.md`.
- **Foco de verificação:**
  - Numeração de artigos, parágrafos e incisos; emendas constitucionais vigentes.
  - **Cada citação conferida contra o texto da fonte.**
...
```markdown
# Área: Noções de Direito Constitucional
