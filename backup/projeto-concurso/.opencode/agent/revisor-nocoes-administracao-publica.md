---
description: Revisor de questões da área Noções de Administração Pública (banco Rio Verde Concurso, arquitetura v3). Recebe o bundle da área do organizador, revisa com a rubrica própria e devolve correções em spec .md. Sequencial, isolado por área.
mode: subagent
permission:
  bash: deny
  edit:
...
- **Fontes:** `DECRETO-LEI Nº 200-1967 - Organização Administrativa.md`, `DECRETO Nº 9.203-2017 - Governança Pública.md`, `LEI Nº 9.784-1999 - PROCESSO ADMINISTRATIVO FEDERAL.md`.
- **Foco de verificação:**
  - Princípios da Administração Pública, poderes administrativos, atos e serviços públicos.
  - Citações conferidas contra o texto da fonte.
...
```markdown
# Área: Noções de Administração Pública
